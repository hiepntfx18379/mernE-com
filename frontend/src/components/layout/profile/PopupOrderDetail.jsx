...
import ProductRow from "../../cartDetail/productRow";
            ...
            <div className="grid grid-flow-col relative justify-stretch w-full 800px:flex">
              <div className=" p-5 mt-1 ">
                <div className="text-left ">
                  <div className="text-xl font-extrabold">Infomation Order</div>
                  ...
                  <div className="text-xl font-extrabold">
                    Total:{" "}
                    {new Intl.NumberFormat("en-DE").format(pro.totalPrice)} VND
                  </div>
                </div>
              </div>
